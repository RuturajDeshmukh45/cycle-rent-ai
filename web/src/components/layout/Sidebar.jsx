...
import {
  LayoutDashboard, MapPin, Bike, Clock, Brain, BarChart2, Leaf, ShieldCheck, X
} from 'lucide-react';
...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    <>
      ...
      <nav className="px-3 space-y-0.5 flex-1">
        ...
        {!isAdmin ? (
          ...
          /* If user IS admin, show only Admin tabs (hide regular user tabs) */
          <>
  ...
  return (
    <>
      {/* 
        Condition 3 FIXED: Changed to 'fixed' position layout container.
        Using fixed positioning tied to left-0 ensures that no matter how far 
        the page layout is scrolled horizontally, the sidebar remains completely locked.
      */}
      <aside
      ...
      {/* Invisible flex-spacer to occupy layout grid slot left behind by absolute/fixed coordinates */}
