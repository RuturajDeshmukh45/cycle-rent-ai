...
// FIX: Field component with proper JSX structure and password toggle
  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        <input
          type={inputType}
          className={`input-field pl-9 ${isPassword ? 'pr-10' : ''} ${error ? 'error' : ''}`}
          {...inputRest}
        />
        {isPassword && (
          <button
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div
          className="mt-4 rounded-xl p-3 text-center text-xs flex items-center justify-center gap-1.5"
